...
const Course = {
    getAll: async (page = 1) => {
        const [rows] = await db.query(
            `SELECT course_id, course_code, course_name, credits, department_id, department_name, instructor_code, ins_fname, ins_lname, start_period, end_period
    ...
    search: async (keyword = '', page = 1, sort = 'course_code', order = 'ASC') => {
        ...
        const [rows] = await db.query(
            `SELECT course_id, course_code, course_name, credits, department_id, department_name, instructor_code, ins_fname, ins_lname, start_period, end_period, enrollment_count
             FROM course_view
