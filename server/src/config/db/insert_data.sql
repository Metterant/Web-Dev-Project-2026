...
-- 2. Insert Students
INSERT INTO student (student_code, first_name, last_name, dob, major, admission_year, email, password_hash) VALUES
('S001', 'Alice', 'Smith', '2006-04-12', 'Computer Science', 2024, 'alice.s@college.edu', 'hash1'),
('S002', 'Bob', 'Jones', '2005-09-03', 'Mathematics', 2023, 'bob.j@college.edu', 'hash2'),
('S003', 'Charlie', 'Brown', '2007-01-25', 'Information Technology', 2025, 'charlie.b@college.edu', 'hash3');
